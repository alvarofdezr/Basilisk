...
Basilisk EDR is an educational cybersecurity project designed for legitimate security research, threat hunting, and defensive security operations. This project should **never be deployed in production environments without thorough security review and hardening**.
